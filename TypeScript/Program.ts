import * as PrintTo255 from "./BasicAlgorithms/PrintTo255"
import * as PrintOddsTo255 from "./BasicAlgorithms/PrintOddsTo255"
...
// PrintOddsTo255.ForOf();
// PrintOddsTo255.While();
...
const testArray: Array<number> = [1, 12, 3, 4, 6]

// IterateArray.For(testArray);
// IterateArray.ForIn(testArray);
// IterateArray.ForOf(testArray);
// IterateArray.While(testArray);
